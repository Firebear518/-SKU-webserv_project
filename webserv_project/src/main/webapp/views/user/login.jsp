				...
				<div class="card shadow-sm border-0 rounded-3">
					<div class="card-body p-5">
						...
						<form action="${pageContext.request.contextPath}/user/login"
							...
							<div class="mb-3">
								<label for="userId" class="form-label fw-semibold">아이디</label> <input
							...
							<div class="text-center small">
								<span class="text-muted">아직 회원이 아니신가요?</span> <a
									href="${pageContext.request.contextPath}/views/user/register.jsp"
									class="text-primary fw-semibold text-decoration-none ms-1">회원가입
									하기</a>
							</div>
